...
BATCH_SIZE=16
MODEL_NAME="dn_detr"
COCO_PATH="/data/LG/coco/cocodataset/" # /home/user/sumin/paper/COCODIR/ for 79 server. /data/LG/coco/cocodataset for 129, 60
...
LEAST_IMAGE=36 #2%
TASK=2
REHEARSAL_FILE="./GM_Hier_Train_1%_least3%/"
