...
def get_args_parser():
    ...
    parser.add_argument('--Sampling_strategy', default='hierarchical', type=str, help="hierarchical(ours), RODEO(del low unique labels), \
                                                                                        random, hier_highloss, hard(high labels)")
